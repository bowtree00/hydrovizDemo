    ...
    d3.json('data/example_6series_json.json', function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for(var key in data[i]) {
                ...
                // MUST UPDATE THIS CONDITIONAL - is hard-coded to ignore 'Date', but it should ignore either a) anything that is not a year (e.g., 1932) or a key, or b) whatever is selected as the x-axis (e.g., if the key 'XYZ' is selected as the x-axis, ignore it)
